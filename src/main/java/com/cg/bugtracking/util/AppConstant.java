...
public class AppConstant {
	...
	//Error Messages
	public static final String PROJECT_NOT_FOUND_CONST = "Product not found for this id: ";
	public static final String EMPLOYEE_NOT_FOUND_CONST = "Employee not found for this id: ";
	public static final String BUG_NOT_FOUND_CONST = "Bug not found for this id: ";
